...
async def start_command(message: types.Message):
    if message.from_user.id == ADMIN_ID:
        ...
        await message.answer("Здравствуйте! Напишите ваш вопрос или отправьте файл, и поддержка ответит вам в ближайшее время. ВНИМАНИЕ! ЭТО НЕ ПОДДЕРЖКА ТЕЛЕГРАММА./nЧтобы связаться со службой поддержки Telegram, заполните форму по адресу https://telegram.org/support.")
