...
async def start_command(message: types.Message):
    if message.from_user.id == ADMIN_ID:
        await message.answer("Привет, Админ! Я готов пересылать тебе обращения. Просто делай Reply на сообщения пользователей, чтобы ответить им.")
    else:
        await message.answer("Здравствуйте! Напишите ваш вопрос или отправьте файл, и поддержка ответит вам в ближайшее время.")
